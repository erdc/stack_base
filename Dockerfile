...
RUN git clone https://github.com/erdc-cm/proteus && \
    ...
    ./hashdist/bin/hit remote add https://192.237.213.149/hashdist_src --objects="source" && \
    ./hashdist/bin/hit remote add https://192.237.213.149/hashdist_jovyan --objects="build" && \
    cd stack && \
